...
\begin{warningbox}[Note]
  Currently, only Ctrl+S is implemented as a global shortcut. Ctrl+Q
  works through the File menu action. Other shortcuts listed in
  previous versions (Ctrl+M, Ctrl+,, Ctrl+H/F1) are not currently
